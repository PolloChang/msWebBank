<bootstrap:table name="search-result">
    ...
    <th data-field="birthday" data-formatter="dateFormatter">${message(code: "ex100.birthday.label")}</th>
    <th data-field="name">${message(code: "ex100.name.label")}</th>
    <th data-field="citycode">${message(code: "ex100.citycode.label")}</th>
    <th data-field="texts" data-formatter="textFormatter">${message(code: "ex100.texts.label")}</th>
